...
__fresh24:
  ...
  %size_entry_ptr93 = getelementptr { i32, [ 0 x i32 ] }* %a91, i32 0, i32 0
  %size94 = load i32* %size_entry_ptr93
  call void @oat_array_bounds_check( i32 %size94, i32 2 )
  %index_ptr92 = getelementptr { i32, [ 0 x i32 ] }* %a91, i32 0, i32 1, i32 2
  %_lhs95 = load i32* %index_ptr92
  ret i32 %_lhs95
}
