...
__fresh0:
  ...
  %s11 = alloca i32
  store i32 0, i32* %s11
  %_lhs13 = load { i32, [ 0 x i32 ] }** %arr10
  %len_ptr14 = getelementptr { i32, [ 0 x i32 ] }* %_lhs13, i32 0, i32 0
  %len15 = load i32* %len_ptr14
  call void @oat_array_bounds_check( i32 %len15, i32 4 )
  %index_ptr12 = getelementptr { i32, [ 0 x i32 ] }* %arr10, i32 0, i32 1, i32 4
  %_lhs16 = load i32* %index_ptr12
  store i32 %_lhs16, i32* %s11
  %_lhs17 = load i32* %s11
  ret i32 %_lhs17
}
