...
__fresh32:
  ...
  %size_entry_ptr141 = getelementptr { i32, [ 0 x i32 ] }* @i135, i32 0, i32 0
  %size142 = load i32* %size_entry_ptr141
  call void @oat_array_bounds_check( i32 %size142, i32 0 )
  %index_ptr140 = getelementptr { i32, [ 0 x i32 ] }* @i135, i32 0, i32 1, i32 0
  %_lhs143 = load i32* %index_ptr140
  ret i32 %_lhs143
}
