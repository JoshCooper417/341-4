...
__fresh26:
  ...
  %size_entry_ptr111 = getelementptr { i32, [ 0 x i32 ] }* %a109, i32 0, i32 0
  %size112 = load i32* %size_entry_ptr111
  call void @oat_array_bounds_check( i32 %size112, i32 2 )
  %index_ptr110 = getelementptr { i32, [ 0 x i32 ] }* %a109, i32 0, i32 1, i32 2
  %_lhs113 = load i32* %index_ptr110
  ret i32 %_lhs113
}
