...
__body48:
  ...
  %size_entry_ptr220 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr216, i32 0, i32 0
  %size221 = load i32* %size_entry_ptr220
  call void @oat_array_bounds_check( i32 %size221, i32 %_lhs214 )
  %index_ptr219 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr216, i32 0, i32 1, i32 %_lhs214
  %_lhs222 = load i32* %index_ptr219
