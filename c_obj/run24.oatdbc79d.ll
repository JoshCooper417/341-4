...
__fresh35:
  ...
  %size_entry_ptr160 = getelementptr { i32, [ 0 x i32 ] }* @a154, i32 0, i32 0
  %size161 = load i32* %size_entry_ptr160
  call void @oat_array_bounds_check( i32 %size161, i32 0 )
  %index_ptr159 = getelementptr { i32, [ 0 x i32 ] }* @a154, i32 0, i32 1, i32 0
  %_lhs162 = load i32* %index_ptr159
  ret i32 %_lhs162
}
